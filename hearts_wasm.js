...
var hearts_wasm = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(hearts_wasm) {
  hearts_wasm = hearts_wasm || {};
...
var Module = typeof hearts_wasm !== 'undefined' ? hearts_wasm : {};
...
// The name 'Module' is an internal name. A promise to instance of it is returned from
// the factory function that is the one and only export of the module -- in our case
// the module named `wasiexperiment`.
...
var wasmBinaryFile;
  wasmBinaryFile = 'hearts_wasm.wasm';
...
var ASM_CONSTS = {
  31944: function() {throw 'Canceled!'},  
 31962: function($0, $1) {setTimeout(function() { __emscripten_do_dispatch_to_thread($0, $1); }, 0);}
};
function initPthreadsJS(){ PThread.initRuntime(); }
  ...
  var PThread={unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],initMainThreadBlock:function() {
        ...
        var pthreadMainJs = locateFile('hearts_wasm.worker.js');
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(4, 1, __environ, environ_buf);
  try {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(5, 1, penviron_count, penviron_buf_size);
  try {
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(7, 1, fd, pbuf);
  try {
...
var proxiedFunctionTable = [null,_atexit,___sys_open,_emscripten_set_canvas_element_size_main_thread,_environ_get,_environ_sizes_get,_fd_close,_fd_fdstat_get,_fd_read,_fd_seek,_fd_write];
...
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 31932;
var __emscripten_main_thread_futex = Module['__emscripten_main_thread_futex'] = 36048;
...
run();
  ...
  return hearts_wasm.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = hearts_wasm;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return hearts_wasm; });
else if (typeof exports === 'object')
  exports["hearts_wasm"] = hearts_wasm;
